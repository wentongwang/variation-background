...
@Entity
@Table(name = "variation_basic_chr10")
public class VariationBasicChr10 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr10 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
