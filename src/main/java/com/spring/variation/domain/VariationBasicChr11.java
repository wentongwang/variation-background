...
@Entity
@Table(name = "variation_basic_chr11")
public class VariationBasicChr11 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr11 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
