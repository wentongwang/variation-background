...
@Entity
@Table(name = "variation_basic_chr12")
public class VariationBasicChr12 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr12 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
