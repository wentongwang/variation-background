...
@Entity
@Table(name = "variation_basic_chr13")
public class VariationBasicChr13 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr13 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
