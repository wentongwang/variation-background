...
@Entity
@Table(name = "variation_basic_chr14")
public class VariationBasicChr14 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr14 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
