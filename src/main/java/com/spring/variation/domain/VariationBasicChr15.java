...
@Entity
@Table(name = "variation_basic_chr15")
public class VariationBasicChr15 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr15 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
