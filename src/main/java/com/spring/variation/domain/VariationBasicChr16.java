...
@Entity
@Table(name = "variation_basic_chr16")
public class VariationBasicChr16 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr16 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
