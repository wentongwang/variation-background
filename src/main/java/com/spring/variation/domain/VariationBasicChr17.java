...
@Entity
@Table(name = "variation_basic_chr17")
public class VariationBasicChr17 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr17 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
