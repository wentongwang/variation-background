...
@Entity
@Table(name = "variation_basic_chr18")
public class VariationBasicChr18 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr18 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
