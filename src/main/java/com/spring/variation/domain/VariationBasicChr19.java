...
@Entity
@Table(name = "variation_basic_chr19")
public class VariationBasicChr19 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr19 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
