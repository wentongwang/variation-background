...
@Entity
@Table(name = "variation_basic_chr2")
public class VariationBasicChr2 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr2 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
