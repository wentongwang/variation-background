...
@Entity
@Table(name = "variation_basic_chr20")
public class VariationBasicChr20 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr20 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
