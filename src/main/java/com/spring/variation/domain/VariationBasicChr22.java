...
@Entity
@Table(name = "variation_basic_chr22")
public class VariationBasicChr22 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr22 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
