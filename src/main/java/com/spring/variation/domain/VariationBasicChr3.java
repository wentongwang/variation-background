...
@Entity
@Table(name = "variation_basic_chr3")
public class VariationBasicChr3 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr3 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
