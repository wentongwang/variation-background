...
@Entity
@Table(name = "variation_basic_chr4")
public class VariationBasicChr4 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr4 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
