...
@Entity
@Table(name = "variation_basic_chr5")
public class VariationBasicChr5 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr5 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
