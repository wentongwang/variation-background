...
@Entity
@Table(name = "variation_basic_chr6")
public class VariationBasicChr6 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr6 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
