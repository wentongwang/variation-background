...
@Entity
@Table(name = "variation_basic_chr7")
public class VariationBasicChr7 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr7 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
