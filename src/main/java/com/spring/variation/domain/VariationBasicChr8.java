...
@Entity
@Table(name = "variation_basic_chr8")
public class VariationBasicChr8 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr8 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
