...
@Entity
@Table(name = "variation_basic_chr9")
public class VariationBasicChr9 implements Serializable {
	...
	public String toString() {
		return "VariationBasicChr9 [Id=" + Id + ", Chrom=" + Chrom + ", Start=" + Start + ", End=" + End + ", Ref="
